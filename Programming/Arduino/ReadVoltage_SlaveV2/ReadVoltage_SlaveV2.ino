/*
  ...
  SLAVE UNIT Version 2 with messag iD included
  ...
  if(str_buffer.substring(1,3) == deviceID)
  {
    ...
    if(str_buffer.substring(3,7) == "CHID")
    {
      ...
      { // If is all OK then write the data
        // Change device ID
        Serial.print("Change Device ID from ");
    ...
    //  “aXXV?-----“ 
    else if(str_buffer.substring(5,7) == "V?")
    {
      // Show voltage
      Serial.print("a");
      Serial.print(deviceID);
    ...
    //  To ask the set-point we can send:
    //  “aXXI?-----“ 
    else if(str_buffer.substring(5,7) == "I?")
    {
      // Show current
      Serial.print("a");
      Serial.print();
    ...
    //  To ask the set-point we can send:
    //  “aXXP?-----“ 
    else if(str_buffer.substring(5,7) == "P?")
    {
      // Show voltage
      Serial.print("a");
      Serial.print(str_buffer.substring(3,5));
    ...
    //  To ask the set-point we can send:
    //  “aXXB1?-----“ 
    else if(str_buffer.substring(5,8) == "B1?")
    {
      // Show voltage
      Serial.print("a");
      Serial.print(str_buffer.substring(3,5));
    ...
    //  To ask the set-point we can send:
    //  “aXXB2?-----“ 
    else if(str_buffer.substring(5,8) == "B2?")
    {
      // Show voltage
      Serial.print("a");
      Serial.print(str_buffer.substring(3,5));
    ...
    //  To ask the set-point we can send:
    //  “aXXB3?-----“ 
    else if(str_buffer.substring(5,8) == "B3?")
    {
      // Show voltage
      Serial.print("a");
      Serial.print(str_buffer.substring(3,5));
